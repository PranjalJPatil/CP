    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CB.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v){
                Toast.makeText(scheduledDriverDet.this,"You have Succesfully canceled your Journey",Toast.LENGTH_SHORT).show();
                getval();
            }
        });
        ...
        SJ.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(scheduledDriverDet.this,"Your Journey has Started",Toast.LENGTH_SHORT).show();
        ...
        EJ.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v){
                Toast.makeText(scheduledDriverDet.this,"Your Journey has Ended",Toast.LENGTH_SHORT).show();
